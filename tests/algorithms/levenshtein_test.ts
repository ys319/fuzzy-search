...
Deno.test("Levenshtein - Bitap with long pattern (>32 chars)", () => {
    ...
    const long1 = "this is a very long string with more than thirty two characters";
    const long2 = "this is a very long string with more than thirty too characters";
...
Deno.test("Levenshtein - prefix/suffix trimming consistency", () => {
    ...
    const algoNoTrim = new LevenshteinAlgorithm({ usePrefixSuffixTrimming: false });
